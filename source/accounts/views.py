...
class LogInView(GuestOnlyView, FormView):
    ...
    subject = 'InterviewChimp'
    # s = choices('1')
    n = random.randint(1,9)
    html_template = f'accounts/Q{n}.html'
    html_message = render_to_string(html_template, {'context': 'values'})
...
class SignUpView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        if settings.ENABLE_USER_ACTIVATION:
            ...
            subject = 'InterviewChimp'
            body = 'Welcome to InterviewChimp!'
            from_email = settings.EMAIL_HOST_USER
            to_list = [user.email]
...
def sendallmails(request):
    ...
    subject = 'InterviewChimp'
    html_template = 'accounts/mail_template.html'
